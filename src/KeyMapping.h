...
struct KeyMappingEntry {
    int vkCode;    QString keyName;    bool enableKeyDown;    bool enableKeyUp;    bool filterRepeats;    bool suppressRepeats;    MidiMessage keyDownMessage;    MidiMessage keyUpMessage;    

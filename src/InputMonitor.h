...
private:
    ...
    QVBoxLayout *m_layout;    QTextEdit *m_console;    QPushButton *m_clearButton;    QCheckBox *m_ignoreRepeatsCheckBox;    QLabel *m_statusLabel;    
    bool m_ignoreRepeats;    bool m_loggingEnabled;    int m_eventCount;};